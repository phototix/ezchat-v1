...
function themeColor(e) {
    ...
    document.querySelectorAll(".theme-img , .theme-color").forEach(function (o) {
        ...
        n &&
            ...
            e && ((l = window.getComputedStyle(i[0], null).getPropertyValue("background-image")), (document.querySelector(".user-chat").style.backgroundImage = l))),
            o.addEventListener("click", function (e) {
                ...
                r &&
                    ...
                    t && ((n = window.getComputedStyle(l[0], null).getPropertyValue("background-image")), (document.querySelector(".user-chat").style.backgroundImage = n)));
            });
    });
}
!(function () {
                ...
                document.querySelectorAll("#favourite-users li, #usersList li").forEach(function (l) {
                    l.addEventListener("click", function (e) {
                        ...
                        s
                            ...
                            : (document.querySelector(".user-own-img .avatar-sm").setAttribute("src", n),
                              document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", n),
                              document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", n));
            ...
            null !== e
                ...
                : ((callList = t),
                  callList.forEach(function (e, t) {
                      var a =
                              !0 === e.callVideo
                                  ? '<button type="button" class="btn btn-link p-0 font-size-20 stretched-link" data-bs-toggle="modal" data-bs-target=".videocallModal"><i class="' + e.callTypeIcon + '"></i></button>'
                                  : '<button type="button" class="btn btn-link p-0 font-size-20 stretched-link" data-bs-toggle="modal" data-bs-target=".audiocallModal"><i class="' + e.callTypeIcon + '"></i></button>',
                ...
                document.querySelectorAll("#callList li").forEach(function (i) {
                    i.addEventListener("click", function (e) {
                        ...
                        s
                            ...
                            : (document.querySelector(".audiocallModal .img-thumbnail").setAttribute("src", n), document.querySelector(".videocallModal .videocallModal-bg").setAttribute("src", n));
                    });
                });
        }),
                          ...
                          i.querySelectorAll(".download-file").forEach(function (i) {
                              i.addEventListener("click", function (e) {
                                  ...
                                  window.File && window.FileReader && window.FileList && window.Blob
                                      ? ((t = new Blob([L[s]], { type: "application/pdf" })), ((a = document.createElement("a")).href = window.URL.createObjectURL(t)), (a.download = L[s].name), a.click())
                          ...
                          document.querySelectorAll(".download-file").forEach(function (i) {
                              i.addEventListener("click", function (e) {
                                  ...
                                  var t,
                                      ...
                                      s = i.getAttribute("data-id");
                                  window.File && window.FileReader && window.FileList && window.Blob
                                      ? ((t = new Blob([L[s]], { type: "application/mp3" })), ((a = document.createElement("a")).href = window.URL.createObjectURL(t)), (a.download = S[s].name), a.click())
                                      : alert("The File APIs are not fully supported in this browser.");
                              });
                          }),
                          document.querySelector(".file_Upload ").classList.remove("show");
                      ...
                      l.forEach(function (t, e) {
                          ...
                          0 < n
                              ...
                              : ((a = t.from_id == v ? " right" : " left"),
                                ...
                                v != t.from_id && (i += '<div class="chat-avatar"><img src="' + s.profile + '" alt=""></div>'),
                                (i += '<div class="user-chat-content">'),
                                (i += H(t.id, t.msg, t.has_images, t.has_files, t.has_dropDown)),
                                l[e + 1] &&
